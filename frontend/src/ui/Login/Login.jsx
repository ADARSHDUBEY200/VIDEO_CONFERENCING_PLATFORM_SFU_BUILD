...
const LoginComponent = () => {
    return (
        ...
        <Glow/>
            ...
            <div className="min-h-screen flex items-center justify-center  bg-gradient-to-r from-[#080820] via-[#141A33] to-[#2A4F9E] p-6">
                <div className='flex justify-center items-center w-[80%] h-[90%] bg-gradient-to-r from-[#0d0d38] via-[#011460] to-[#2A4F9E] rounded-3xl py-6 px-3'>
                    <div className='w-[50%] h-full text-center'>
                        This is the div
                    </div>
                    <div className="w-full max-w-md bg-gradient-to-r from-[#080820] via-[#141A33] to-[#2A4F9E] backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8">
