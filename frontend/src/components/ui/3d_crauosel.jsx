...
const DEFAULT_IMAGES = ['/images/landing/LandingImage.jpg', 'https://i.pinimg.com/1200x/1e/0c/1c/1e0c1c9c868bf07b4c27a275fb3087af.jpg', 'https://i.pinimg.com/736x/30/91/09/3091098a15810ddbbd58d5e007bc7207.jpg', 'https://i.pinimg.com/736x/07/cf/4a/07cf4a3a6f4144b4c7ac8e2ec5978dc1.jpg', 'https://i.pinimg.com/736x/5d/bf/f2/5dbff2b4c0fdcb9815e989f0db386f95.jpg'];
const CARD_W = 180;
const CARD_H = 240;
const RADIUS = 240;
...
const ThreeDCarousel = React.memo(({
  ...
  return <div ref={parentRef} className="w-full h-full flex items-center justify-center overflow-hidden font-sans cursor-grab active:cursor-grabbing" style={{
    userSelect: 'none'
      ...
      width: Math.max(cardW * 5, radius * 2.2),
